...
export default function HomePage() {
  ...
  const medecins = [
    ...
    {
      nom: 'Dr. Mohamed Ould Salem',
      specialite: 'Pédiatre',
      hopital: 'Clinique El Wafa',
      note: 4.8,
      avis: 98,
    },
    {
      nom: 'Dr. Mariem Bint Cheikh',
      specialite: 'Gynécologue',
      hopital: 'Polyclinique Capitale',
      note: 4.7,
      avis: 87,
    },
  ]
              ...
              <Link href="/medecins" key={i}>
                <Card className="border-0 shadow-sm hover:shadow-md hover:border-blue-200 border transition-all cursor-pointer">
                  <CardContent className="pt-6 flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900 text-sm">{s.nom}</p>
